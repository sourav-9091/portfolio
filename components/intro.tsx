...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-[55px]">Hello, </span>
        <span className="font-bold text-[55px]">I'm Sourav Goel.</span>
        <br/><br/>
        I'm a{" "}
        <span className="font-bold">Full-Stack Web Developer and Flutter App Developer</span>{" "}
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/sourav-goel-8bb559217"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/sourav-9091"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
